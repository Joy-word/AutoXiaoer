...
object ScreenshotAnnotator {
    ...
    fun createAnnotation(
        action: com.flowmate.autoxiaoer.action.AgentAction,
        screenWidth: Int,
        screenHeight: Int,
    ): ActionAnnotation = when (action) {
        is com.flowmate.autoxiaoer.action.AgentAction.Tap -> {
        ...
        is com.flowmate.autoxiaoer.action.AgentAction.Swipe -> {
        ...
        is com.flowmate.autoxiaoer.action.AgentAction.LongPress -> {
        ...
        is com.flowmate.autoxiaoer.action.AgentAction.DoubleTap -> {
        ...
        is com.flowmate.autoxiaoer.action.AgentAction.Type -> {
            ActionAnnotation.TypeText(action.text)
        }

        is com.flowmate.autoxiaoer.action.AgentAction.TypeName -> {
            ActionAnnotation.TypeText(action.text)
        }

        is com.flowmate.autoxiaoer.action.AgentAction.Batch -> {

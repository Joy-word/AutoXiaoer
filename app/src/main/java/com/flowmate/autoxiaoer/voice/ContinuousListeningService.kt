package com.flowmate.autoxiaoer.voice
...
class ContinuousListeningService : Service() {
    ...
    companion object {
        ...
        // Actions
        const val ACTION_START = "com.flowmate.autoxiaoer.voice.START_LISTENING"
        const val ACTION_STOP = "com.flowmate.autoxiaoer.voice.STOP_LISTENING"

        // Broadcast actions
        const val ACTION_WAKE_WORD_DETECTED = "com.flowmate.autoxiaoer.voice.WAKE_WORD_DETECTED"

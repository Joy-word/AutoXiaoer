...
class FloatingWindowToggleActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!FloatingWindowService.canDrawOverlays(this)) {
            ...
            val mainIntent =
                Intent(this, com.flowmate.autoxiaoer.MainActivity::class.java).apply {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.flowmate.autoxiaoer.ACTION_TOGGLE_FLOATING"
        const val ACTION_SHOW = "com.flowmate.autoxiaoer.ACTION_SHOW_FLOATING"
        const val ACTION_HIDE = "com.flowmate.autoxiaoer.ACTION_HIDE_FLOATING"
    }
}

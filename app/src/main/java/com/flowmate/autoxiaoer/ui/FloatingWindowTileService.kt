...
class FloatingWindowTileService : TileService() {
    ...
    private fun updateTileState() {
        ...
        tile.label = getString(com.flowmate.autoxiaoer.R.string.tile_floating_window)
        tile.contentDescription = getString(com.flowmate.autoxiaoer.R.string.tile_floating_window_desc)
